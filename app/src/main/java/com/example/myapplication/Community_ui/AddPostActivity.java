        ...
        mAddPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!caption.isEmpty() && postImageUri !=null){
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        firestore.collection("Posts").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                               if (task.isSuccessful()){
                                                   mProgressBar.setVisibility(View.INVISIBLE);
                                                   Toast.makeText(AddPostActivity.this, "글이 성공적으로 올라갔습니다!!", Toast.LENGTH_SHORT).show();
                                                   startActivity(new Intent(AddPostActivity.this , Community.class));
                                                   finish();
                                               }else{
                                                   mProgressBar.setVisibility(View.INVISIBLE);
                    ...
                    mProgressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(AddPostActivity.this, "이미지와 내용을 입력하세요.", Toast.LENGTH_SHORT).show();
                }
            }
        });
